...
<div class="body-area">
		...
		<c:if test="${not empty picImg}">
			...
			<img src="${pageContext.request.contextPath}/resources/images/profileupload.png" alt="Avatar" class="page_pic" data-tooltip="Click here">
				 ...
				 <h1><a href="${pageContext.request.contextPath}/user/dashboard"  style="margin-top:10%;color:red "><span><img src="${pageContext.request.contextPath}/resources/images/download.png" style="margin-top: 1%; background-color: transparent;" src="arrow.gif" width="5%" height="4%"/>&nbsp;BACK</span></a></h1>
