...
<div class="body-area">
	...
	<div class="information">
	 ...
	 <div class="containersearch">
						  ...
						  <p style="margin-left:10%;color:black">John Doe saved us from a web disaster.
						  John Doe saved us from a web disaster.John Doe saved us from a web disaster.
						  John Doe saved us from a web disaster.John Doe saved us from a web disaster.
						  John Doe saved us from a web disaster.John Doe saved us from a web disaster.
						  John Doe saved us from a web disaster.John Doe saved us from a web
						  </p>
